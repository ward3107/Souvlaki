          ...
          <ParallaxLayer depth={0.5} className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <MagneticButton
                ...
                className="px-8 py-4 bg-green-500 hover:bg-green-600 text-white rounded-full font-semibold text-lg shadow-lift hover:shadow-pop transition-all active:scale-[0.97] inline-block"
                ariaLabel={tx(
                  lang,
                  'הזמינו בוואטסאפ',
                  'Order on WhatsApp',
