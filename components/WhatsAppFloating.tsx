  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-24 sm:bottom-28 right-4 sm:right-6 rtl:right-auto rtl:left-4 sm:rtl:left-6 z-45 w-11 h-11 sm:w-14 sm:h-14 bg-white text-black rounded-full flex items-center justify-center shadow-xl mix-blend-difference hover:scale-110 transition-all duration-300"
        aria-label="Chat on WhatsApp"
      >
        <svg viewBox="0 0 24 24" className="w-6 h-6 sm:w-8 sm:h-8 fill-current" aria-hidden="true">
