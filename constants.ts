...
> = {
  ...
  [Language.EL]: {
    ...
    description:
      'Αυθεντικό ελληνικό σουβλάκι στο Κουφ Γιασίφ. Φρέσκος πίτες, γύρος, σουβλάκια και πολλά περισσότερα. Παραγγείλετε τώρα! Ανοιχτά Τετ-Σαβ 13:00-00:00. Τηλ 04-812-2980. Ελληνικό εστιατόριο',
    keywords:
    ...
    ogDescription:
      'Το καλύτερο ελληνικό σουβλάκι στο Κουφ Γιασίφ! Φρέσκος πίτες, ζουμερός γύρος, σουβλάκια στην φωτιά. Ανοιχτά Τετ-Σαβ 13:00-00:00. Παραγγείλετε τώρα!',
    ogLocale: 'el_IL',
  },
  [Language.EN]: {
...
export const FAQS: FAQItem[] = [
  {
    ...
    answer: {
      he: 'המסעדה פתוחה בימים רביעי עד שבת, בין השעות 13:00 עד 00:00. ימים ראשון עד שלישי המסעדה סגורה.',
      en: 'The restaurant is open Wednesday to Saturday, between 13:00 and 00:00. Sunday to Tuesday the restaurant is closed.',
      ar: 'المطعم مفتوح من الأربعاء إلى السبت، بين الساعات 13:00 و 00:00. الأحد إلى الثلاثاء المطعم مغلق.',
      ru: 'Ресторан открыт со среды по субботу, с 13:00 до 00:00. Воскресенье-вторник ресторан закрыт.',
      el: 'Το εστιατόριο είναι ανοιχτό Τετάρτη έως Σάββατο, από 13:00 έως 00:00.',
    },
  },
  {
    id: '2',
