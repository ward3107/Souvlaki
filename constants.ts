...
export const REVIEWS: Review[] = [
  {
    ...
    date: '2 weeks ago',
    text: {
      he: 'הסובלאקי הכי טעים שאכלתי בארץ! שירות מעולה ואווירה נהדרת.',
      en: 'Best souvlaki I have eaten in the country! Excellent service and great atmosphere.',
      ar: 'أفضل سوفلاكي أكلته في البلاد! خدمة ممتازة وجو رائع.',
      ru: 'Лучший сувлаки, который я ел в стране! Отличный сервис и атмосфера.',
      el: 'Το καλύτερο σουβλάκι που έχω φάει στη χώρα!',
    },
  },
  {
    id: '2',
    ...
    date: '1 month ago',
    text: {
      he: 'אוכל טרי וטעים מאוד. המקום נקי והצוות אדיב.',
      en: 'Very fresh and tasty food. The place is clean and the staff is kind.',
      ar: 'طعام طازج ولذيذ جداً. المكان نظيف والموظفون لطفاء.',
      ru: 'Очень свежая и вкусная еда. Место чистое, персонал вежливый.',
      el: 'Πολύ φρέσκο και νόστιμο φαγητό.',
    },
  },
  {
    id: '3',
    author: 'Alex Dimitriou',
    rating: 5,
    date: '3 weeks ago',
    text: {
      he: 'מרגיש כמו ביוון. הגירוס מצוין והצזיקי מושלם.',
      en: 'Feels like Greece. The gyros is excellent and the tzatziki is perfect.',
      ar: 'تشعر وكأنك في اليونان. الجيروس ممتاز والتزاتزيكي مثالي.',
      ru: 'Как будто в Греции. Гирос отличный, дзадзики идеальный.',
      el: 'Σαν να είσαι στην Ελλάδα. Ο γύρος είναι εξαιρετικός.',
    },
  },
];
...
export const FAQS: FAQItem[] = [
  {
    ...
    question: {
      ...
      ru: 'Каковы часы работы?',
      el: 'Ποιες είναι οι ώρες λειτουργίας;',
    },
    answer: {
      he: 'רביעי עד שבת: 13:00 - 01:00. ראשון עד שלישי: סגור.',
      en: 'Wednesday to Saturday: 13:00 - 01:00. Sunday to Tuesday: Closed.',
      ar: 'الأربعاء إلى السبت: 13:00 - 01:00. الأحد إلى الثلاثاء: مغلق.',
      ru: 'Со среды по субботу: 13:00 - 01:00. Воскресенье-вторник: закрыто.',
      el: 'Τετάρτη έως Σάββατο: 13:00 - 01:00.',
    },
  },
  {
    id: '2',
    question: {
      he: 'האם המקום כשר?',
      en: 'Is the place Kosher?',
      ar: 'هل المكان كوشير؟',
      ru: 'Место кошерное?',
      el: 'Είναι το μέρος Kosher;',
    },
    answer: {
      he: 'אנחנו משתמשים במוצרים כשרים אך המקום פתוח בשבת.',
      en: 'We use Kosher products but we are open on Saturday.',
      ar: 'نستخدم منتجات كوشير لكننا نفتح يوم السبت.',
      ru: 'Мы используем кошерные продукты, но открыты в субботу.',
      el: 'Χρησιμοποιούμε προϊόντα Kosher αλλά είμαστε ανοιχτά το Σάββατο.',
    },
  },
];