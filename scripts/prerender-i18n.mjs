...
const C = {
  ...
  he: {
    ...
    ogLocale: 'he_IL',
    h1: 'סובלאקי יווני בכפר יאסיף',
    intro:
      'סובלאקי, גירוס ושיפודים על האש עטופים בפיתה יוונית טרייה — נצלים לפי הזמנה בכפר יאסיף, בגליל המערבי.',
    menuHeading: 'מהתפריט',
    menu: [
      'סובלאקי בפיתה עם צזיקי, ירקות טריים וצ׳יפס (החל מ־30 ₪)',
      'גירוס יווני בפיתה',
      'שיפודים צלויים על האש',
      'סובלאקי טבעוני בפיתה (30 ₪)',
  ...
  el: {
    ...
    ogLocale: 'el_IL',
    h1: 'Ελληνικό σουβλάκι στο Καφρ Γιασίφ',
    intro:
      'Σουβλάκι και γύρος σε φρέσκια ελληνική πίτα — ψήνονται κατά παραγγελία στο Καφρ Γιασίφ, στη Δυτική Γαλιλαία.',
    menuHeading: 'Στο μενού',
    menu: [
      'Σουβλάκι σε πίτα με τζατζίκι, φρέσκα λαχανικά και πατάτες (από ₪30)',
      'Ελληνικός γύρος σε πίτα',
      'Σουβλάκια στη φωτιά',
      'Βίγκαν σουβλάκι σε πίτα (₪30)',
      'Επιλογή πίτας χωρίς γλουτένη (₪40)',
    ],
    visitHeading: 'Επισκεφθείτε μας',
    address: 'Οδός 70, Καφρ Γιασίφ, Δυτική Γαλιλαία, Ισραήλ',
    hoursLabel: 'Ώρες',
