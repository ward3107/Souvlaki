...
const C = {
  ...
  he: {
    ...
    description:
      'סובלקי יווני אותנטי בכפר יאסיף. פיתה טרה, גירוס, שישודים ועוד. הזמן עכשיו! פתוח רביעי-שבת 13:00-00:00. התקשרו 04-812-2980. מסעדה יוונית מקומית',
    keywords:
    ...
    ogDescription:
      'הכי טוב סובלקי יווני בכפר יאסיף! פיתה טרה, גירוס עסיסי, שישודים על האש. פתוח רביעי-שבת 13:00-00:00. הזמן עכשיו!',
    ogLocale: 'he_IL',
  ...
  el: {
    ...
    description:
      'Αυθεντικό ελληνικό σουβλάκι στο Κφαρ Γιασίφ. Φρέσκια πίτα, γύρος, σουβλάκια και άλλα. Παραγγείλετε τώρα! Ανοιχτά Τετ-Σαβ 13:00-00:00. Τηλ 04-812-2980. Ελληνικό εστιατόριο',
    keywords:
    ...
    ogDescription:
      'Το καλύτερο ελληνικό σουβλάκι στο Κφαρ Γιασίφ! Φρέσκια πίτα, ζουμερός γύρος, σουβλάκια στη φωτιά. Ανοιχτά Τετ-Σαβ 13:00-00:00. Παραγγείλετε τώρα!',
    ogLocale: 'el_IL',
